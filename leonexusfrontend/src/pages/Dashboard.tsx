...
import { Car, dealerCarsApi, dealershipApi, Dealership, bulkCarApi, getCarImageUrl } from "@/services/api";
                ...
                {cars.map((car) => (
                  <Card key={car.id} className="overflow-hidden">
                    <div className="aspect-video bg-muted relative">
                      <img
                        src={getCarImageUrl(car, { width: 300, height: 200, crop: 'fill', quality: 'auto' })}
