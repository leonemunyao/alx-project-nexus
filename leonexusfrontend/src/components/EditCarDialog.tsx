...
import { categoriesApi, Category, Car as CarType, dealerCarsApi } from "@/services/api";

interface EditCarDialogProps {
  isOpen: boolean;
  onClose: () => void;
  onEdit?: (carData: CarType) => void;
  car: CarType;
}

const EditCarDialog = ({ isOpen, onClose, onEdit, car }: EditCarDialogProps) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log('Updated car response:', updatedCar);
      ...
      toast({
        ...
        description: "There was an error updating the car details",
        variant: "destructive",
      });
    } finally {
